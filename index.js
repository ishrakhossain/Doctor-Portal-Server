...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.cuf1v.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
...
client.connect((err) => {
  ...
  app.post('/addADoctor', (req, res) => {
    ...
    doctorCollection
      .insertOne({ name, email, contact, image })
      .then((result) => {
        res.send(result.insertedCount > 0)
      })
  })
